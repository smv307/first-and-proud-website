function Lander() {
    return (
        <article className="flex-parent" id="lander-section">
            ...
            <figure>
                <img src="public/images/gradcap.png" id="lander-image" alt="Graduation cap" className="lander-img" width="100%" />
            </figure>
        </article>
    );
}
...
function Information() {
    return (
        <article className="flex-parent" id="info-section">
            ...
            <figure>
                <img className="small-img" src="public/images/members.jpg" alt="Members of First and Proud club" width="100%" height="500" />
            </figure>
            <section>
            ...
            <section>
                <ul className="inria-sans mustard-text large-font">
                    <li className="flex-parent contact-item">
                        <img src="public/images/icons/email.png" alt="Gmail logo" width="80" height="60" />
                        <p>PLACEHOLDER@GMAIL.COM</p>
                    </li>
                    <li className="flex-parent contact-item">
                        <img src="public/images/icons/insta.png" alt="Instagram logo" width="80" height="80" />
